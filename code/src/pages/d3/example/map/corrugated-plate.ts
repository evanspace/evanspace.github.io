...
export const createCorrugatedPlate = (range = 500, interval?: number, size?: number) => {
  ...
  const material = new THREE.ShaderMaterial({
    //  着色器代码 变量
    uniforms: {
      color: { value: new THREE.Color(0x5588aa) },
      tcolor: { value: new THREE.Color(0x00b8a9) },
      radius: { value: 1.25 },
      length: { value: range / 3 }, // 扫过区域(宽度)
