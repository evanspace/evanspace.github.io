...
export const pipeMeshName = ['贴图']
export const pipeModelType = [
  'LDH_PIPE_ERECT',
  'LDH_PIPE_RIGHT_ANGLE',
  'LDG_PIPE_ERECT',
  'LDG_PIPE_RIGHT_ANGLE',
  'LQG_PIPE_ERECT',
  'LQG_PIPE_RIGHT_ANGLE',
  'LQH_PIPE_ERECT',
  'LQH_PIPE_RIGHT_ANGLE'
]

export const textModelType = ['LDB', 'LQB', 'JSQ', 'SB', 'LXJ', 'LGJ', 'LGJ_2', 'LGJ_3', 'LGJ_4', 'LQT', 'BSHLQ', 'XBC']
export const animationModelType = ['LDB', 'LQB', 'SB', 'LXJ', 'LGJ', 'LGJ_2', 'LGJ_3', 'LGJ_4', 'LQT']
...
export const getOpts = (): {
  ...
  hdr: '/textures/hdr/skidpan_2k.hdr',
  devEnv: devEnv,
  loadCache: true,
  dotShowStrict: false,
