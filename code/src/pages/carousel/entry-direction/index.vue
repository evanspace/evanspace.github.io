  ...
  <div class="page">
    <div class="box" @mouseenter="onMouseEnter" @mouseleave="cl = ''" ref="boxRef">
      <div class="img-wrap" :class="cl">
        <img :src="base + '/imgs/common/01.jpg'" alt="" />
        <img :src="base + '/imgs/common/01.jpg'" alt="" />
        <img :src="base + '/imgs/common/01.jpg'" alt="" />
        <img :src="base + '/imgs/common/02.jpg'" alt="" />
        <img :src="base + '/imgs/common/03.jpg'" alt="" />
        <img :src="base + '/imgs/common/04.jpg'" alt="" />
        <img :src="base + '/imgs/common/05.jpg'" alt="" />
        <img :src="base + '/imgs/common/05.jpg'" alt="" />
        <img :src="base + '/imgs/common/05.jpg'" alt="" />
      </div>
    </div>
